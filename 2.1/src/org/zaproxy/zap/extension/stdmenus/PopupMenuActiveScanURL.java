...
public class PopupMenuActiveScanURL extends PopupMenuSiteNode {
    ...
    public PopupMenuActiveScanURL(String label) {
        super(label);
        this.setIcon(new ImageIcon(PopupMenuActiveScanURL.class.getResource("/resource/icon/16/093.png")));
    }
