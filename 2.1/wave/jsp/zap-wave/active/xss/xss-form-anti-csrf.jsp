...
<body>
<H2>OWASP ZAP WAVE - XSS in a Form parameter with an anti CSRF token in it</H2>
<H3>Description</H3>
The 'name' parameter in the form is written to the page with script and SCRIPT tabs being stripped. It will still be vulnerable to script injection attacks.<br>
...
<%
	...
	String anticsrf = request.getParameter("anticsrf");
	if (request.getMethod().equals("POST") && name != null) {
		if (anticsrf != null && anticsrf.equals(request.getSession().getAttribute("anticsrf"))) {
			...
			out.println("Bad request - the anti CSRF tokens dont match<br/><br/>");
		}
	}
...
<form method="POST">
	<table>
	<tr>
	<td>Anti CSRF Token:</td>
	<td><input id="anticsrf" name="anticsrf" value="<%=anticsrf%>"></input></td>
	</tr>
	<tr>
	<td>Name:</td>
