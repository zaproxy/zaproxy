...
<H3>Description</H3>
The 'name' parameter in the form is written to the page if (and only if) its used as a URL parameter without being sanitised and so is vulnerable to a simple script injection attack.<br>
