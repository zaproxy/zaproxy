    ...
    format ("license", {
        ...
        target(project.fileTree(project.projectDir) {
            include(listOf(
                ...
                "src/main/java/org/parosproxy/paros/core/scanner/ScannerParamFilterRule.java",
                "src/main/java/org/parosproxy/paros/core/scanner/ScannerParamFilterRules.java",
                "src/main/java/org/parosproxy/paros/core/scanner/ScannerParamValueFilterRule.java",
