...
public class ResponseHeaderStringHttpPanelViewModel extends AbstractStringHttpPanelViewModel {
	
	private static Logger log = Logger.getLogger(ResponseHeaderStringHttpPanelViewModel.class);
