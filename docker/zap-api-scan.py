...
def main():
    ...
    parser.add_argument("-S", "--safe", action='store_true', default=False, help="safe mode this will skip the active scan and perform a baseline scan")
    ...
    parser.add_argument("-O", default='', dest='override', help="the hostname to override in the (remote) OpenAPI spec")
    ...
    parser.add_argument("--schema", default='', help="GraphQL schema location, URL or file, e.g. https://www.example.com/schema.graphqls\n")
