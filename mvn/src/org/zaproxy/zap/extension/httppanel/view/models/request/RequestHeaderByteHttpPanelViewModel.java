...
public class RequestHeaderByteHttpPanelViewModel extends AbstractByteHttpPanelViewModel {
	
	private static Logger log = Logger.getLogger(RequestHeaderByteHttpPanelViewModel.class);
