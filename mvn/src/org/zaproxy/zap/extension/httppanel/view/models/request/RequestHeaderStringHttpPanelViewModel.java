...
public class RequestHeaderStringHttpPanelViewModel extends AbstractStringHttpPanelViewModel {
	
	private static Logger log = Logger.getLogger(RequestHeaderStringHttpPanelViewModel.class);
