...
public class ResponseByteHttpPanelViewModel extends AbstractByteHttpPanelViewModel {
	
	private static Logger log = Logger.getLogger(ResponseByteHttpPanelViewModel.class);
