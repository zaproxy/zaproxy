...
class context(object):
	...
	def context_list(self):
		...
		"""
		return next(six.itervalues(self.zap._request(self.zap.base + 'context/view/contextList/')))
	...
	def exclude_regexs(self, contextname):
		...
		return next(six.itervalues(
			self.zap._request(self.zap.base + 'context/view/excludeRegexs/', {'contextName': contextname})))
	...
	def include_regexs(self, contextname):
		...
		"""
		return next(six.itervalues(
			self.zap._request(self.zap.base + 'context/view/includeRegexs/', {'contextName': contextname})))
	...
	def context(self, contextname):
		...
		"""
		return next(
			six.itervalues(self.zap._request(self.zap.base + 'context/view/context/', {'contextName': contextname})))
	...
	def technology_list(self):
		...
		"""
		return next(six.itervalues(self.zap._request(self.zap.base + 'context/view/technologyList/')))
	...
	def included_technology_list(self, contextname):
		...
		"""
		return next(six.itervalues(
			self.zap._request(self.zap.base + 'context/view/includedTechnologyList/', {'contextName': contextname})))
	...
	def excluded_technology_list(self, contextname):
		...
		"""
		return next(six.itervalues(
			self.zap._request(self.zap.base + 'context/view/excludedTechnologyList/', {'contextName': contextname})))

	def exclude_from_context(self, contextname, regex, apikey=''):
		"""
		Add exclude regex to context
		"""
		return next(six.itervalues(self.zap._request(self.zap.base + 'context/action/excludeFromContext/',
		                                             {'contextName': contextname, 'regex': regex, 'apikey': apikey})))

	def include_in_context(self, contextname, regex, apikey=''):
		"""
		Add include regex to context
		"""
		return next(six.itervalues(self.zap._request(self.zap.base + 'context/action/includeInContext/',
		                                             {'contextName': contextname, 'regex': regex, 'apikey': apikey})))
	...
	def new_context(self, contextname, apikey=''):
		...
		"""
		return next(six.itervalues(self.zap._request(self.zap.base + 'context/action/newContext/',
	...
	def remove_context(self, contextname, apikey=''):
		...
		"""
		return next(six.itervalues(self.zap._request(self.zap.base + 'context/action/removeContext/',
		                                             {'contextName': contextname, 'apikey': apikey})))
	...
	def export_context(self, contextname, contextfile, apikey=''):
		...
		"""
		return next(six.itervalues(self.zap._request(self.zap.base + 'context/action/exportContext/',
	...
	def import_context(self, contextfile, apikey=''):
		...
		"""
		return next(six.itervalues(self.zap._request(self.zap.base + 'context/action/importContext/',
	...
	def include_context_technologies(self, contextname, technologynames, apikey=''):
		...
		"""
		return next(six.itervalues(self.zap._request(self.zap.base + 'context/action/includeContextTechnologies/',
	...
	def include_all_context_technologies(self, contextname, apikey=''):
		...
		"""
		return next(six.itervalues(self.zap._request(self.zap.base + 'context/action/includeAllContextTechnologies/',
		                                             {'contextName': contextname, 'apikey': apikey})))
	...
	def exclude_context_technologies(self, contextname, technologynames, apikey=''):
		...
		"""
		return next(six.itervalues(self.zap._request(self.zap.base + 'context/action/excludeContextTechnologies/',
		                                             {'contextName': contextname, 'technologyNames': technologynames,
		                                              'apikey'     : apikey})))
	...
	def exclude_all_context_technologies(self, contextname, apikey=''):
		...
		"""
		return next(six.itervalues(self.zap._request(self.zap.base + 'context/action/excludeAllContextTechnologies/',
		                                             {'contextName': contextname, 'apikey': apikey})))
	...
	def set_context_in_scope(self, contextname, booleaninscope, apikey=''):
		...
		"""
		return next(six.itervalues(self.zap._request(self.zap.base + 'context/action/setContextInScope/',
