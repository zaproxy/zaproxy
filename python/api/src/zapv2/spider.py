...
class spider(object):
    ...
    def scan(self, url, maxchildren='', recurse='', apikey=''):
        """
        ...
        """
        return next(self.zap._request(self.zap.base + 'spider/action/scan/', {'url' : url, 'maxChildren' : maxchildren, 'recurse' : recurse, 'apikey' : apikey}).itervalues())
