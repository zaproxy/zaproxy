...
public class KeyStoreNetBeans extends JDialog {
    ...
    private void initComponents() {
        ...
        setActiveButton.setText(Constant.messages.getString("certificates.keystore.button.activate"));
        ...
        deleteButton.setText(Constant.messages.getString("certificates.keystore.button.delete"));
        ...
        certificatejTabbedPane.addTab(Constant.messages.getString("certificates.keystore.title"), keyStorePanel);

        fileLabel.setText(Constant.messages.getString("certificates.pkcs12.label.file"));

        browseButton.setText(Constant.messages.getString("certificates.pkcs12.button.browse"));
        ...
        passwordPkcs12Label.setText(Constant.messages.getString("certificates.pkcs12.label.password"));

        addPkcs12Button.setText(Constant.messages.getString("certificates.pkcs12.button.add"));
        ...
        certificatejTabbedPane.addTab(Constant.messages.getString("certificates.pkcs12.title"), pkcs12Panel);

        driverLabel.setText(Constant.messages.getString("certificates.pkcs11.label.driver"));
        ...
        passwordPkcs11Label.setText(Constant.messages.getString("certificates.pkcs11.label.pincode"));

        addPkcs11Button.setText(Constant.messages.getString("certificates.pkcs11.button.add"));
        ...
        certificatejTabbedPane.addTab(Constant.messages.getString("certificates.pkcs11.title"), pkcs11Panel);
        ...
        certificatejTabbedPane.addTab(Constant.messages.getString("certificates.cryptoapi.title"), cryptoApiPanel);

        useClientCertificateCheckBox.setText(Constant.messages.getString("certificates.checkbox.enable"));
        ...
        certificateLabel.setText(Constant.messages.getString("certificates.label.active"));
