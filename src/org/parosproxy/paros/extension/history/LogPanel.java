...
public class LogPanel extends AbstractPanel {
	...
	private JButton getFilterButton() {
		if (filterButton == null) {
			...
			filterButton.setIcon(new ImageIcon(LogPanel.class.getResource("/resource/icon/16/funnel.png")));	// 'filter' icon
	...
	private JButton getApplyFilterButton() {
		if (applyFilterButton == null) {
			...
			applyFilterButton.setIcon(new ImageIcon(LogPanel.class.getResource("/resource/icon/16/funnel--arrow.png")));
			applyFilterButton.setToolTipText(Constant.messages.getString("history.filter.apply.button.tooltip"));
	...
	private JButton getResetFilterButton() {
		if (resetFilterButton == null) {
			...
			resetFilterButton.setIcon(new ImageIcon(LogPanel.class.getResource("/resource/icon/16/funnel--cancel.png")));
			resetFilterButton.setToolTipText(Constant.messages.getString("history.filter.reset.button.tooltip"));
	...
	private JButton getOptionsButton() {
		if (optionsButton == null) {
			...
			optionsButton.setToolTipText(Constant.messages.getString("history.filter.options.button.tooltip"));
			...
			optionsButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					Control.getSingleton()
							.getMenuToolsControl()
							.options(Constant.messages.getString("history.filter.options.title"));
				}
			});
		}
