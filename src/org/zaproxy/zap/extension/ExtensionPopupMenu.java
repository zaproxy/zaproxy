...
public class ExtensionPopupMenu extends JMenu implements ExtensionPopupMenuComponent {
	 ...
	 * {@code ExtensionPopupMenuComponent#getMenuIndex()}, should be honoured.
	 * <p>
	 * Default is {@code false}.
	 * </p>
	 * <p>
	 * The child components will be ordered from minor to greater index (starting at index 0 from top of the menu). If two or
	 * more child components have the same index, the index that those child components will have, between each other, is
	 * undefined.
	 * </p>
	 * <p>
	 * Note: Separators added manually (with {@code ExtensionPopupMenu#addSeparator()} or
	 * {@code ExtensionPopupMenu#addSeparator(int)} are not preserved between reorderings.
	 * </p>
	 * 
	 * @param orderChildren {@code true} if the child components should ordered, {@code false} otherwise.
	 * @see #isOrderChildren()
	 * @see #processExtensionPopupChildren(PopupMenuUtils.PopupMenuInvokerWrapper)
