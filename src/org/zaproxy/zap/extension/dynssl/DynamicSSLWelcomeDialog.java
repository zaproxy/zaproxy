...
public class DynamicSSLWelcomeDialog extends AbstractDialog {
	...
	private final JButton btnCreate = new JButton(Constant.messages.getString("dynssl.button.generate"));
	private final JButton btnLater = new JButton(Constant.messages.getString("dynssl.button.later"));
