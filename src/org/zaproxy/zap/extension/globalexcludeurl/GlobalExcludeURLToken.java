...
public class GlobalExcludeURLToken implements Cloneable {
	...
	public GlobalExcludeURLToken(HttpMessage msg, String name, String value, int formIndex) {
		super();
		this.msg = msg;
		this.name = name;
		this.value = value;
	...
	@Override	
	public GlobalExcludeURLToken clone () {
		return new GlobalExcludeURLToken(msg, name, value, formIndex);
	}
