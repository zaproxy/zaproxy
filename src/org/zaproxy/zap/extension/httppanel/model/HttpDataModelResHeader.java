...
public class HttpDataModelResHeader extends HttpDataModel {

	public HttpDataModelResHeader(HttpPanel httpPanel,
	...
	public void textDataToView() {
		httpPanelTextUi.setData(getHttpMessage().getResponseHeader().toString());
