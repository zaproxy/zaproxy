 ...
 */
package org.zaproxy.zap.extension.httppanel.view.text.menus;
...
public class ViewMenu extends ExtensionPopupMenu {
	...
	private static final String MENU_LABEL = Constant.messages.getString("http.panel.text.popup.view.label");
	private static final String ANTI_ALIASING = Constant.messages.getString("http.panel.text.popup.view.antiAliasing");
	private static final String SHOW_LINE_NUMBERS = Constant.messages.getString("http.panel.text.popup.view.showLineNumbers");
	private static final String WORD_WRAP = Constant.messages.getString("http.panel.text.popup.view.wordWrap");
	private static final String HIGHLIGHT_CURRENT_LINE = Constant.messages.getString("http.panel.text.popup.view.highlightCurrentLine");
	private static final String FADE_CURRENT_HIGHLIGHT_LINE = Constant.messages.getString("http.panel.text.popup.view.fadeCurrentHighlightLine");
	private static final String SHOW_WHITESPACE_CHARACTERS = Constant.messages.getString("http.panel.text.popup.view.showWhitespaceCharacters");
	private static final String SHOW_NEWLINE_CHARACTERS = Constant.messages.getString("http.panel.text.popup.view.showNewlineCharacters");
	private static final String MARK_OCCURRENCES = Constant.messages.getString("http.panel.text.popup.view.markOccurrences");
	private static final String ROUNDED_SELECTION_EDGES = Constant.messages.getString("http.panel.text.popup.view.roundedSelectionEdges");
	private static final String BRACKET_MATCHING = Constant.messages.getString("http.panel.text.popup.view.bracketMatching");
	private static final String ANIMATED_BRACKET_MATCHING = Constant.messages.getString("http.panel.text.popup.view.animatedBracketMatching");
	...
	public void updateState(HttpPanelTextArea httpPanelTextArea) {
	...
	private static class ChangeAntiAliasingAction extends TextAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (textComponent instanceof HttpPanelTextArea) {
				HttpPanelTextArea httpPanelTextArea = (HttpPanelTextArea)textComponent;
