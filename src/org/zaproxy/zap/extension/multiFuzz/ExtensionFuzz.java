	...
	public List<SearchResult> searchFuzzResults(Pattern pattern, boolean inverse) {
	    if (fuzzableMessageHandlers != null) {
	        ...
	        for(Class<? extends Message> m : fuzzableMessageHandlers.keySet()){
	        	results.addAll(fuzzableMessageHandlers.get(m).searchResults(pattern, inverse));
	        }
	        return results;
	    }
            ...
            popupFuzzMenu.addActionListener(new java.awt.event.ActionListener() {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                	...
                	if (source != null && source instanceof PopupFuzzMenu) {
                		FuzzableComponent invoker = (FuzzableComponent) ((PopupFuzzMenu)source).getLastInvoker();
                		getFuzzableMessageHandler((invoker.getMessageClass())).showFuzzDialog(invoker);
                	}
                }
            });
        }
