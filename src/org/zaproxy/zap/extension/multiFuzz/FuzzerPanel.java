...
public class FuzzerPanel extends AbstractPanel {
	...
	private void initialize() {
		...
		// Wont need to do this if/when this class is changed to extend
		// ScanPanel
	...
	private javax.swing.JToolBar getPanelToolbar() {
		if (panelToolbar == null) {
			...
			gridBagConstraints8.insets = new java.awt.Insets(0, 5, 0, 5); // Slight
																			// indent
	...
	private JProgressBar getProgressBar() {
		if (progressBar == null) {
			progressBar = new JProgressBar(0, 100); // Max will change as scan
													// progresses
	...
	/*
	 * private JButton getStartScanButton() { if (startScanButton == null) {
	 * startScanButton = new JButton();
	 * startScanButton.setToolTipText(Constant.messages
	 * .getString("fuzz.toolbar.button.start")); startScanButton.setIcon(new
	 * ImageIcon(FuzzerPanel.class.getResource("/resource/icon/16/131.png")));
	 * startScanButton.setEnabled(false); startScanButton.addActionListener(new
	 * ActionListener () {
	 * 
	 * @Override public void actionPerformed(ActionEvent e) { startScan(); }
	 * 
	 * });
	 * 
	...
	private JButton getStopScanButton() {
		if (stopScanButton == null) {
			...
			stopScanButton.setToolTipText(Constant.messages
					.getString("fuzz.toolbar.button.stop"));
			stopScanButton.setIcon(new ImageIcon(FuzzerPanel.class
					.getResource("/resource/icon/16/142.png")));
	...
	private JToggleButton getPauseScanButton() {
		if (pauseScanButton == null) {
			...
			pauseScanButton.setToolTipText(Constant.messages
					.getString("fuzz.toolbar.button.pause"));
			pauseScanButton.setSelectedToolTipText(Constant.messages
					.getString("fuzz.toolbar.button.unpause"));
			pauseScanButton.setIcon(new ImageIcon(FuzzerPanel.class
					.getResource("/resource/icon/16/141.png")));
	...
	private JButton getOptionsButton() {
		if (optionsButton == null) {
			...
			optionsButton.setToolTipText(Constant.messages
					.getString("fuzz.toolbar.button.options"));
			optionsButton.setIcon(new ImageIcon(FuzzerPanel.class
