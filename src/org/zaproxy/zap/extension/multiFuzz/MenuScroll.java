 ...
 * <P>
 * Implementation taken from MenuScroller located in {@literal http://http://www.camick.com/java/source/MenuScroller.java}, 
 * at the "Java Tips Weblog". Code posted on that blog is free to use.<br>
...
public class MenuScroll extends JMenu{
   ...
   */
  public static MenuScroll setScrollerFor(JMenu menu, int scrollCount, int interval) {
   ...
   * @throws IllegalArgumentException if scrollCount or interval is 0 or negative
   */
  public static MenuScroll setScrollerFor(JPopupMenu menu, int scrollCount, int interval) {
    return new MenuScroll(menu, scrollCount, interval);
  }
  ...
  /**
   * Removes this MenuScroll from the associated menu and restores the
  ...
  /**
   * Ensures that the <code>dispose</code> method of this MenuScroll is
