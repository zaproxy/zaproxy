...
public class PassiveScanParam extends AbstractParam {
    ...
    /**
     * Sets whether or not the passive scan should be performed on traffic
     * from the fuzzer.
     *
     * @param scanFuzzerMessages
     *            {@code true} if the scan should be performed on traffic
     *            generated by the fuzzer, {@code false} otherwise.
    ...
    /**
     * Adds or removes the {@code HistoryReference} types that should be included 
     * when passive scanning traffic from the fuzzer.
     *
     * @param shouldOptin
     *            {@code true} if the types should be enabled (added)
     *            {@code false} if the types should be disabled (removed)
     * @since TODO Add version
     * @see #isScanFuzzerMessages()
     ...
     *
     * @return {@code true} if the scan should be performed on traffic from the fuzzer, {@code false} otherwise.
     * @since TODO Add version
