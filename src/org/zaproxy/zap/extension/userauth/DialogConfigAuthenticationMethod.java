 ...
 */
public class DialogConfigAuthenticationMethod<T extends AuthenticationMethod<T>> extends AbstractFormDialog {
...
//
//	private AuthenticationMethodType<T> authenticationMethodFactory;
...
//
	public DialogConfigAuthenticationMethod(Dialog owner, String title,
			AuthenticationMethodType<T> factory, T existingMethod, int contextId) {
