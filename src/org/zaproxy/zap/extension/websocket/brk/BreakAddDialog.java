...
public class BreakAddDialog extends AbstractDialog {
    ...
    public BreakAddDialog(WebSocketBreakpointsUiManagerInterface breakPointsManager) throws HeadlessException {
    ...
    public void setMessage(WebSocketMessageDAO aMessage) {
        getComboBox().setSelectedItem(aMessage.readableOpcode);
    }
		...
		if (btnAdd == null) {
			...
			btnAdd.addActionListener(new java.awt.event.ActionListener() { 
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
				    breakPointsManager.addBreakpoint(new WebSocketBreakpointMessage((String)getComboBox().getSelectedItem()));
