...
public class BreakEditDialog extends AbstractDialog {
	...
	private WebSocketBreakpointsUiManagerInterface breakPointsManager;

    public BreakEditDialog(WebSocketBreakpointsUiManagerInterface breakPointsManager) throws HeadlessException {
    ...
    public void setBreakpoint(WebSocketBreakpointMessage breakpoint) {
        ...
        getComboBox().setSelectedItem(breakpoint.getOpcode());
    }
		...
		if (btnSave == null) {
			...
			btnSave.addActionListener(new java.awt.event.ActionListener() { 
				...
				public void actionPerformed(java.awt.event.ActionEvent e) {
				    breakPointsManager.editBreakpoint(breakpoint, new WebSocketBreakpointMessage((String)getComboBox().getSelectedItem()));
                    breakpoint = null;
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setViewportView(getComboBox());
