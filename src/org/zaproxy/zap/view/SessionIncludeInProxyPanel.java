...
public class SessionIncludeInProxyPanel extends AbstractParamPanel {

	public static final String PANEL_NAME = Constant.messages.getString("session.proxy.include.title");
    ...
    public SessionIncludeInProxyPanel() {
        super();
 		initialize();
	}
	...
	private JPanel getPanelSession() {
		if (panelSession == null) {
			...
			panelSession.setName("Includeproxy");
			...
			jLabel.setText(Constant.messages.getString("session.proxy.label.include"));
	...
	public void initParam(Object obj) {
	    ...
	    regexesPanel.setRegexes(session.getIncludeInProxyRegexs());
	    regexesPanel.setRemoveWithoutConfirmation(
	            !Model.getSingleton().getOptionsParam().getViewParam().isConfirmRemoveProxyIncludeRegex());
	}
	...
	public void saveParam (Object obj) throws Exception {
	    Session session = (Session) obj;
	    session.setIncludeInProxyRegexs(regexesPanel.getRegexes());
	    Model.getSingleton().getOptionsParam().getViewParam().setConfirmRemoveProxyIncludeRegex(
