...
/**
 * A {@code ExtensionPopupMenuItemMessageContainer} that exposes the state of {@code HttpMessageContainer}s.
 * 
 * @since 2.3.0
...
public abstract class PopupMenuItemHttpMessageContainer extends ExtensionPopupMenuItemMessageContainer {
    ...
    /**
     * Constructs a {@code PopupMenuItemHttpMessageContainer} with the given label and with no support for multiple selected
    ...
    /**
     * Constructs a {@code PopupMenuItemHttpMessageContainer} with the given label and whether or not the menu item supports
    ...
    /**
     * Tells whether or not the menu item supports multiple selected messages. If {@code false} the menu item button will not be
     * enabled when the invoker has multiple selected messages.
     * 
     * @return {@code true} if the menu item supports multiple selected messages, {@code false} otherwise.
     ...
     * <p>
     * Defaults to call the method {@code performActions(List)} with the selected messages obtained by calling the method
     * {@code getSelectedMessages(HttpMessageContainer)}, with the given message container as parameter.
     * </p>
     * <p>
