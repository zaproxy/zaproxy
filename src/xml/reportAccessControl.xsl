	...
	<xsl:template match="/report">
		...
		<html>
			<head>
				...
				<style>
					#table{width:100%;border:0;font-family:Arial,Helvetica,sans-serif}#table
					thead
			...
			<body>
				...
				<button onclick="illegal()">Illegal accesses</button>
				<button onclick="legal()">Valid accesses</button>
						...
						<xsl:for-each select="results/result">
							<tr>
								...
								<xsl:for-each select="userResult">
									...
									<td>
										<xsl:value-of select="@access-control" />
									</td>
								</xsl:for-each>
							</tr>
						</xsl:for-each>
