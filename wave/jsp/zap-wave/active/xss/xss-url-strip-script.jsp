...
<body>
<H2>OWASP ZAP WAVE - XSS in a URL parameter with the script tab stripped out</H2>
<H3>Description</H3>
The 'name' parameter in the URL is written to the page with script and SCRIPT tabs being stripped. It will still be vulnerable to script injection attacks.<br>
