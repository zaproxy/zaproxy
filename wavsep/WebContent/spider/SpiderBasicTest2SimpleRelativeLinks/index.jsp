...
<body>
	...
	<p>This test is for simple relative links.</p>
	<br />
	<a href="a.jsp">Visit this page</a><br/>
	<a
		href="<%=Utils.getStrippedUrl(request.getRequestURI()).toString()%>b.jsp">Also
		visit this page</a><br/>
	<a href="../..<%=Utils.getStrippedUrl(request.getServletPath())%>c.jsp">Also
		visit this page</a>
