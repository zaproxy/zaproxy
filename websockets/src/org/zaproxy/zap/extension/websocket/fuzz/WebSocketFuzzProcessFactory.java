...
public class WebSocketFuzzProcessFactory implements FuzzProcessFactory {

    private WebSocketFuzzableTextMessage fuzzableMessage;
	private Map<Integer, WebSocketProxy> wsProxies;
	private WebSocketFuzzAbortListener abortListener;

    public WebSocketFuzzProcessFactory(WebSocketFuzzableTextMessage fuzzableMessage, Map<Integer, WebSocketProxy> wsProxies) {
