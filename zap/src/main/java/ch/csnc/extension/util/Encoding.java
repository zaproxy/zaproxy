...
public final class Encoding {
    ...
    /**
     * Encodes a byte array to a Base64 encoded String. <br>
     * (cf. RFC 1341 section 5.2) This implementation heavily outperforms sun.misc.BASE64Encoder,
     * which is not "officially" available anyway (about four times faster on 1.3 and about double
     * speed on 1.4).
     *
    ...
    public static String base64encode(byte[] code) {
        ...
        if (0 == code.length) return new String();
        int len = code.length;
     ...
     * (cf. RFC 1341 section 5.2) NOTE: This decoder silently ignores all legal line breaks in the
     * input and throws a RuntimeException on any illegal input. This impl slightly outperforms
     * sun's decoder on 1.3 and heavily outperforms it on 1.4 (about a third faster).
     *
     ...
     * @return a hexadecimal (lower-case-based) String representation of the byte array
     */
