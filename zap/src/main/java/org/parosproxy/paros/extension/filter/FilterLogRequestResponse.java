...
public class FilterLogRequestResponse extends FilterAdaptor {
    ...
    private static final String logFile =
            Paths.get(Constant.FOLDER_FILTER, "message.txt").toString();
    ...
    public void onHttpResponseReceive(HttpMessage httpMessage) {
        ...
        if (!httpMessage.getRequestHeader().isText()
                || httpMessage.getRequestHeader().isImage()
                || httpMessage.getResponseHeader().isImage()) {
            return;
        }
