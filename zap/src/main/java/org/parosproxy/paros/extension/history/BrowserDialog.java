...
public class BrowserDialog extends AbstractDialog {
    ...
    private static final Logger logger = LogManager.getLogger(BrowserDialog.class);
    ...
    private void capture() {
        try {
                    ...
                    new Robot()
                            .createScreenCapture(
                                    new Rectangle(
                                            ...
                                            this.getY(),
                                            this.getWidth(),
                                            this.getHeight() - this.jPanelBottom.getHeight()));
            // Save as JPEG
            ...
            if (file != null) ImageIO.write(screencapture, "png", file);
        } catch (Exception e) {
    ...
    private JButton getBtnClose() {
        if (btnClose == null) {
            ...
            btnClose.addActionListener(
                    new ActionListener() { // Close this window
                        @Override
