...
public class ManualHttpRequestEditorDialog
    ...
    public ManualHttpRequestEditorDialog(boolean isSendEnabled, String configurationKey)
            throws HeadlessException {
        this(isSendEnabled, configurationKey, null);
    }

    public ManualHttpRequestEditorDialog(
    ...
    private static final class RequestResponsePanel extends JPanel {
        ...
        public void loadConfig() {
            ...
            changeView(
                    Model.getSingleton()
                            .getOptionsParam()
                            .getConfig()
                            .getInt(configurationKey + SELECTEDLAYOUT_CONFIG_KEY, TABS_VIEW));
        ...
        public void saveConfig() {
            ...
            Model.getSingleton()
                    .getOptionsParam()
                    .getConfig()
                    .setProperty(configurationKey + SELECTEDLAYOUT_CONFIG_KEY, currentView);
