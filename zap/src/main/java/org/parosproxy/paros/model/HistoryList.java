...
/**
 * @deprecated (2.3.0) Replaced with use of {@link
 *     org.zaproxy.zap.view.table.HistoryReferencesTableModel}. It will be removed in a future
 *     release.
 */
@Deprecated
public class HistoryList extends DefaultListModel<HistoryReference> {
    ...
    // Note: implementation copied from base class (DefaultListModel) but changed to call the local
