...
public class OptionsCheckForUpdatesPanel extends AbstractParamPanel {
    ...
    private JPanel getPanelMisc() {
        if (panelMisc == null) {
            ...
            dirsPanel.add(
                    ...
                    LayoutHelper.getGBC(0, 0, 2, 1.0D, 1.0D));
            JLabel downloadDirLabel =
                    new JLabel(Constant.messages.getString("cfu.options.downloaddir.label"));
    ...
    private void setCheckBoxStates() {
        if (chkCheckOnStart.isSelected()) {
            ...
            getChkReportAlphaAddons()
                    .setEnabled(
                            this.getChkReportReleaseAddons().isSelected()
                                    && this.getChkReportBetaAddons().isSelected());
    ...
    private JCheckBox getChkCheckOnStart() {
        if (chkCheckOnStart == null) {
            ...
            chkCheckOnStart.addItemListener(
                    new ItemListener() {
                        @Override
    ...
    private JCheckBox getChkDownloadNewRelease() {
        if (chkDownloadNewRelease == null) {
            ...
            chkDownloadNewRelease.setText(
                    Constant.messages.getString("cfu.options.downloadNewRelease"));
            ...
            if (Constant.isKali()) {
                chkDownloadNewRelease.setText(
                        Constant.messages.getString("cfu.options.downloadNewRelease.kali"));
            }
        }
    ...
    private JCheckBox getChkCheckAddonUpdates() {
        if (chkCheckAddonUpdates == null) {
            ...
            chkCheckAddonUpdates.setText(
                    Constant.messages.getString("cfu.options.checkAddonUpdates"));
            ...
            chkCheckAddonUpdates.addItemListener(
                    new ItemListener() {
                        @Override
                        public void itemStateChanged(ItemEvent e) {
                            setCheckBoxStates();
    ...
    private JCheckBox getChkInstallAddonUpdates() {
        if (chkInstallAddonUpdates == null) {
            ...
            chkInstallAddonUpdates.setText(
                    Constant.messages.getString("cfu.options.installAddonUpdates"));
    ...
    private JCheckBox getChkInstallScannerRules() {
        if (chkInstallScannerRules == null) {
            ...
            chkInstallScannerRules.setText(
                    Constant.messages.getString("cfu.options.installScannerRules"));
    ...
    private JCheckBox getChkReportReleaseAddons() {
        if (chkReportReleaseAddons == null) {
            ...
            chkReportReleaseAddons.setText(
                    Constant.messages.getString("cfu.options.reportReleaseAddons"));
            ...
            chkReportReleaseAddons.addItemListener(
                    new ItemListener() {
                        @Override
                        public void itemStateChanged(ItemEvent e) {
                            setCheckBoxStates();
    ...
    private JCheckBox getChkReportBetaAddons() {
        if (chkReportBetaAddons == null) {
            ...
            chkReportBetaAddons.setText(
                    Constant.messages.getString("cfu.options.reportBetaAddons"));
            ...
            chkReportBetaAddons.addItemListener(
                    new ItemListener() {
                        @Override
                        public void itemStateChanged(ItemEvent e) {
                            setCheckBoxStates();
    ...
    private JCheckBox getChkReportAlphaAddons() {
        if (chkReportAlphaAddons == null) {
            ...
            chkReportAlphaAddons.setText(
                    Constant.messages.getString("cfu.options.reportAlphaAddons"));
    ...
    private OptionsAutoupdateDirsTableModel getScriptDirModel() {
        if (scriptDirModel == null) {
            ...
            scriptDirModel.addTableModelListener(
    ...
    private void repopulateDownloadDirs() {
        ...
        // The selected item may no longer exist, but that's ok as it will correctly default to the
        // first one
    ...
    public void initParam(Object obj) {
        ...
        getChkDownloadNewRelease()
                .setSelected(options.getCheckForUpdatesParam().isDownloadNewRelease());
        getChkCheckAddonUpdates()
                .setSelected(options.getCheckForUpdatesParam().isCheckAddonUpdates());
        getChkInstallAddonUpdates()
                .setSelected(options.getCheckForUpdatesParam().isInstallAddonUpdates());
        getChkInstallScannerRules()
                .setSelected(options.getCheckForUpdatesParam().isInstallScannerRules());
        getChkReportReleaseAddons()
                .setSelected(options.getCheckForUpdatesParam().isReportReleaseAddons());
        getChkReportBetaAddons()
                .setSelected(options.getCheckForUpdatesParam().isReportBetaAddons());
        getChkReportAlphaAddons()
                .setSelected(options.getCheckForUpdatesParam().isReportAlphaAddons());
        getScriptDirModel().setFiles(options.getCheckForUpdatesParam().getAddonDirectories());
        getDownloadDirCombo()
                .setSelectedItem(
                        options.getCheckForUpdatesParam().getDownloadDirectory().getAbsolutePath());
    ...
    public void saveParam(Object obj) throws Exception {
        ...
        options.getCheckForUpdatesParam()
                .setDownloadNewRelease(getChkDownloadNewRelease().isSelected());
        options.getCheckForUpdatesParam()
                .setCheckAddonUpdates(getChkCheckAddonUpdates().isSelected());
        options.getCheckForUpdatesParam()
                .setInstallAddonUpdates(getChkInstallAddonUpdates().isSelected());
        options.getCheckForUpdatesParam()
                .setInstallScannerRules(getChkInstallScannerRules().isSelected());
        options.getCheckForUpdatesParam()
                .setReportReleaseAddons(getChkReportReleaseAddons().isSelected());
        options.getCheckForUpdatesParam()
                .setReportBetaAddons(getChkReportBetaAddons().isSelected());
        options.getCheckForUpdatesParam()
                .setReportAlphaAddons(getChkReportAlphaAddons().isSelected());
        options.getCheckForUpdatesParam().setAddonDirectories(getScriptDirModel().getElements());
        options.getCheckForUpdatesParam()
                .setDownloadDirectory(new File(getDownloadDirCombo().getSelectedItem().toString()));
    }
    ...
    private static class CfuDirsOptionsPanel extends AbstractMultipleOptionsBaseTablePanel<File> {
        ...
        private static final String REMOVE_DIALOG_TITLE =
                Constant.messages.getString("cfu.options.dialog.dirs.remove.title");
        private static final String REMOVE_DIALOG_TEXT =
                Constant.messages.getString("cfu.options.dialog.dirs.remove.text");
        private static final String REMOVE_DIALOG_CONFIRM_BUTTON_LABEL =
                Constant.messages.getString("cfu.options.dialog.dirs.remove.button.confirm");
        private static final String REMOVE_DIALOG_CANCEL_BUTTON_LABEL =
                Constant.messages.getString("cfu.options.dialog.dirs.remove.button.cancel");
        private static final String REMOVE_DIALOG_CHECKBOX_LABEL =
                Constant.messages.getString("cfu.options.dialog.dirs.remove.checkbox.label");
