...
public class EncodeDecodeDialog extends AbstractFrame {
        ...
        if (jPanel == null) {
            ...
            */
            ...
            addField(
                    jPanel1,
                    1,
                    getBase64EncodeField(),
                    Constant.messages.getString("enc2.label.b64Enc"));
            addField(
                    jPanel1,
                    2,
            ...
            addField(
                    jPanel2,
                    1,
                    getBase64DecodeField(),
                    Constant.messages.getString("enc2.label.b64Dec"));
            addField(
                    jPanel2,
                    2,
            ...
            addField(
                    ...
                    1,
                    getSha1HashField(),
                    Constant.messages.getString("enc2.label.sha1Hash"));
            addField(
                    jPanel3,
                    2,
                    getMd5HashField(),
                    Constant.messages.getString("enc2.label.md5Hash"));

            addField(
                    jPanel4,
                    1,
                    getIllegalUTF82ByteField(),
            ...
            addField(
                    ...
                    1,
                    getEscapedTextField(),
                    Constant.messages.getString("enc2.label.unicode.escapedText"));
            addField(
                    jPanel5,
                    2,
                    getUnescapedTextField(),
                    Constant.messages.getString("enc2.label.unicode.unescapedText"));
    ...
    private void updateEncodeDecodeFields() {
        ...
        asciiHexEncodeField.setText(
                getEncoder().getHexString(getInputField().getText().getBytes()));
        ...
        try {
            sha1HashField.setText(
                    getEncoder()
                            .getHexString(
                                    getEncoder()
                                            .getHashSHA1(getInputField().getText().getBytes())));
        } catch (final Exception e) {
            sha1HashField.setText("");
        }
        ...
        try {
            md5HashField.setText(
                    getEncoder()
                            .getHexString(
                                    getEncoder().getHashMD5(getInputField().getText().getBytes())));
        } catch (final Exception e) {
            md5HashField.setText("");
        }
        ...
        try {
            illegalUTF82ByteField.setText(
                    getEncoder().getIllegalUTF8Encode(getInputField().getText(), 2));
        } catch (final Exception e) {
            // Not unexpected
            illegalUTF82ByteField.setText("");
        }
        ...
        try {
            illegalUTF83ByteField.setText(
                    getEncoder().getIllegalUTF8Encode(getInputField().getText(), 3));
        } catch (final Exception e) {
            // Not unexpected
            illegalUTF83ByteField.setText("");
        }
        ...
        try {
            illegalUTF84ByteField.setText(
                    getEncoder().getIllegalUTF8Encode(getInputField().getText(), 4));
        } catch (final Exception e) {
            // Not unexpected
            illegalUTF84ByteField.setText("");
        }
