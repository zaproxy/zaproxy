...
public class ExtensionHttpPanelLargeResponseView extends ExtensionAdaptor {
    ...
    public String getUIName() {
        return Constant.messages.getString("http.panel.view.largeresponse.ext.name");
    }
    ...
    public void hook(ExtensionHook extensionHook) {
        ...
        if (getView() != null) {
            ...
            panelManager.addResponseViewFactory(
                    ResponseSplitComponent.NAME, new ResponseLargeResponseSplitViewFactory());
            panelManager.addResponseDefaultViewSelectorFactory(
                    ResponseSplitComponent.NAME,
                    new LargeResponseDefaultSplitViewSelectorFactory());

            panelManager.addResponseViewFactory(
                    ResponseAllComponent.NAME, new ResponseLargeResponseAllViewFactory());
            panelManager.addResponseDefaultViewSelectorFactory(
                    ResponseAllComponent.NAME, new LargeResponseDefaultAllViewSelectorFactory());
        }
    }
    ...
    public void unload() {
        if (getView() != null) {
            ...
            panelManager.removeResponseViewFactory(
                    ResponseSplitComponent.NAME, ResponseLargeResponseSplitViewFactory.NAME);
            ...
            panelManager.removeResponseDefaultViewSelectorFactory(
                    ResponseSplitComponent.NAME, LargeResponseDefaultSplitViewSelectorFactory.NAME);
            ...
            panelManager.removeResponseViewFactory(
                    ResponseAllComponent.NAME, ResponseLargeResponseAllViewFactory.NAME);
            panelManager.removeResponseViews(
                    ResponseAllComponent.NAME, ResponseLargeResponseAllView.NAME, null);
            panelManager.removeResponseDefaultViewSelectorFactory(
                    ResponseAllComponent.NAME, LargeResponseDefaultAllViewSelectorFactory.NAME);
            panelManager.removeResponseDefaultViewSelectors(
                    ResponseAllComponent.NAME, LargeResponseDefaultAllViewSelector.NAME, null);
        }
    }
