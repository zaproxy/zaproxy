...
public class RequestStringHttpPanelViewModel extends AbstractStringHttpPanelViewModel {
	
	private static Logger log = Logger.getLogger(RequestStringHttpPanelViewModel.class);
