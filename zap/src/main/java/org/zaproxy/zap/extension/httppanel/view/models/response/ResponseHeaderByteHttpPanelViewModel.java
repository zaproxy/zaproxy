...
public class ResponseHeaderByteHttpPanelViewModel extends AbstractByteHttpPanelViewModel {
	
	private static Logger log = Logger.getLogger(ResponseHeaderByteHttpPanelViewModel.class);
