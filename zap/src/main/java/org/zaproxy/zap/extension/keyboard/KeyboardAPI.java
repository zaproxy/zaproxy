...
public class KeyboardAPI extends ApiImplementor {
    ...
    // img-src 'self' allows the browser to fetch the favicon, as with other API responses.
    ...
    public HttpMessage handleApiOther(HttpMessage msg, String name, JSONObject params)
        ...
        if (OTHER_CHEETSHEET_ACTION_ORDER.equals(name) || OTHER_CHEETSHEET_KEY_ORDER.equals(name)) {
            ...
            String response = buildCheatsheetResponse(shortcuts, subtitleKey, incUnset);
            try {
    ...
    private static String buildCheatsheetResponse(
        ...
        sb.append("<!DOCTYPE html>\n<html lang=\"")
                .append(StringEscapeUtils.escapeHtml4(Constant.messages.getLocal().toLanguageTag()))
                .append("\">\n<head>\n<meta charset=\"UTF-8\">\n<title>")
                .append(escapedTitle)
                .append("</title>\n<style>\n")
