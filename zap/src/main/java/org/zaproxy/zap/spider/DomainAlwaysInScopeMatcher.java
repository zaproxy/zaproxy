...
public class DomainAlwaysInScopeMatcher extends Enableable {
    ...
    public DomainAlwaysInScopeMatcher(String domain) {
        super(true);
    ...
    public DomainAlwaysInScopeMatcher(DomainAlwaysInScopeMatcher other) {
    ...
    public boolean equals(Object object) {
        ...
        DomainAlwaysInScopeMatcher other = (DomainAlwaysInScopeMatcher) object;
        if (domain == null) {
