...
public final class JsonUtil {
    ...
    public static String getJsonKeyString(Object obj) {
        ...
        getJsonKeyString(obj, sb);
        return sb.toString();
    }

    private static void getJsonKeyString(Object obj, StringBuilder sb) {
        try {
            try {
                getJsonObjectKeyString(JSONObject.fromObject(obj), sb);
    ...
    private static void getJsonObjectKeyString(JSONObject jsonObject, StringBuilder sb) {
        sb.append('{');
        String prefix = "";
        for (Object key : jsonObject.keySet()) {
            ...
            if (obj instanceof JSONObject jObj) {
                sb.append(":");
                getJsonKeyString(jObj, sb);
            } else if (obj instanceof JSONArray jArr) {
                sb.append(":");
                getJsonKeyString(jArr, sb);
            }
        }
        sb.append('}');
    }
