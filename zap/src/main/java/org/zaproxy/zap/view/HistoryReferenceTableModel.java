 ...
 *
 * @deprecated (2.3.0) Superseded by {@link org.zaproxy.zap.view.table.HistoryReferencesTableModel}.
...
public class HistoryReferenceTableModel extends AbstractTableModel {
    ...
    private static final String[] COLUMN_NAMES = {
        ...
        Constant.messages.getString(
                "view.href.table.header.tags", "", /* CUSTOM_1 */ "", /* CUSTOM_2 */ "")
    }; /* CUSTOM_3 */
