...
public class NodeSelectDialog extends AbstractDialog {
    ...
    public SiteNode showDialog(SiteNode defaultNode) {
        ...
        if (selectedSiteNode != null) {
            ...
            TreePath path =
                    new TreePath(this.siteTree.getPathToRoot((TreeNode) this.siteTree.getRoot()));
            this.getTreeSite().expandPath(path);
        }
    ...
    public Target showDialog(Target defaultTarget) {
        ...
        if (defaultTarget != null) {
            populateNode(
                    siteRoot, (SiteNode) this.siteTree.getRoot(), defaultTarget.getStartNode());
        } else {
        ...
        if (contextsInScope > 1) {
            ...
            SiteNode node =
                    new SiteNode(
                            ...
                            Constant.messages.getString("context.allInScope"));
    ...
    private DefaultTreeModel emptyContextTree() {
        return new DefaultTreeModel(
                new SiteNode(null, -1, Constant.messages.getString("context.list")));
    }
                    ...
                    new javax.swing.event.TreeSelectionListener() {
                        ...
                        public void valueChanged(javax.swing.event.TreeSelectionEvent e) {
                            ...
                            getSelectButton()
                                    .setEnabled(
                                            node != null
                                                    && (node.getParent() != null || allowRoot));
                        }
                    });
            treeSite.addMouseListener(
    ...
    private JTree getTreeContext() {
        if (treeContext == null) {
            ...
            treeContext.addTreeSelectionListener(
                    new javax.swing.event.TreeSelectionListener() {
