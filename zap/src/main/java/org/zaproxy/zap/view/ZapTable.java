...
public class ZapTable extends JXTable {
    ...
    public void persistColumnConfiguration() {
        ...
        List<javax.swing.table.TableColumn> columns =
                ((DefaultTableColumnModelExt) columnModel).getColumns(false);
    ...
    protected static class ResetColumnsToDefaultAction extends AbstractActionExt {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            table.applyAdditionalColumnConfigurations();
        }
    }

    public static class TableColumnConfiguration {
    ...
    static class TableColumnConfig {
        private String name;
        private int index;
