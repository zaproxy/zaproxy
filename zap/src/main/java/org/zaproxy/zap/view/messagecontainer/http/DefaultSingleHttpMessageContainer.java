 ...
 * @since 2.3.0
 */
public class DefaultSingleHttpMessageContainer extends AbstractHttpMessageContainer
        implements SingleHttpMessageContainer {

    private final HttpMessage httpMessage;

    /**
     * Constructs a {@code DefaultSingleHttpMessageContainer} with no contained {@code HttpMessage}
    ...
    /**
     * Constructs a {@code DefaultSingleHttpMessageContainer} with the given container {@code name}
     * and {@code component} and contained {@code httpMessage}.
     *
     * @param name the name of the container
     * @param component the GUI component of the container
     ...
     *     null}.
     */
    public DefaultSingleHttpMessageContainer(
            String name, Component component, HttpMessage httpMessage) {
