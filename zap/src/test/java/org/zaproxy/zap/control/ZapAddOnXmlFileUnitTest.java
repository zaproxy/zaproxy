...
class ZapAddOnXmlFileUnitTest {
    ...
    void shouldLoadEmptyManifest() throws Exception {
        ...
        assertThat(manifest.getDescription(), isEmptyString());
        ...
        assertThat(manifest.getBundlePrefix(), isEmptyString());
        assertThat(manifest.getHelpSetBaseName(), isEmptyString());
        assertThat(manifest.getHelpSetLocaleToken(), isEmptyString());
