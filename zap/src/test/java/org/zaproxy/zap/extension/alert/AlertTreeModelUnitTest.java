...
public class AlertTreeModelUnitTest extends WithConfigsTest {
    ...
    void shouldAddUniqueAlerts() {
        ...
        assertEquals(a1, atModel.getRoot().getChildAt(0).getChildAt(0).getUserObject());

        // Second child - Medium risk
        assertEquals("Alert A", atModel.getRoot().getChildAt(1).getNodeName());
        assertEquals(Alert.RISK_MEDIUM, atModel.getRoot().getChildAt(1).getRisk());
        assertEquals(2, atModel.getRoot().getChildAt(1).getChildCount());
        ...
        assertEquals(a2, atModel.getRoot().getChildAt(1).getChildAt(0).getUserObject());
        assertEquals(
                ": https://www.example.net",
                atModel.getRoot().getChildAt(1).getChildAt(1).getNodeName());
        assertEquals(Alert.RISK_MEDIUM, atModel.getRoot().getChildAt(1).getChildAt(1).getRisk());
        assertEquals(a3, atModel.getRoot().getChildAt(1).getChildAt(1).getUserObject());
    }
    ...
    void shouldAddDuplicateAlerts() {
        ...
        assertEquals(3, atModel.getRoot().getChildAt(0).getChildAt(0).getAllAlerts().size());
        assertTrue(atModel.getRoot().getChildAt(0).getChildAt(0).hasAlert(a1));
        assertTrue(atModel.getRoot().getChildAt(0).getChildAt(0).hasAlert(a2));
        assertTrue(atModel.getRoot().getChildAt(0).getChildAt(0).hasAlert(a3));
    }
    ...
    @Test
    void shouldNotDeleteDuplicateAlerts() {
        // Given
        Alert a1 =
                newAlert(
                        1,
        ...
        assertEquals(
                ...
                atModel.getRoot().getChildAt(0).getChildAt(0).getNodeName());
        assertEquals(Alert.RISK_MEDIUM, atModel.getRoot().getChildAt(0).getChildAt(0).getRisk());
        assertEquals(2, atModel.getRoot().getChildAt(0).getChildAt(0).getAllAlerts().size());
        assertTrue(atModel.getRoot().getChildAt(0).getChildAt(0).hasAlert(a2));
        assertTrue(atModel.getRoot().getChildAt(0).getChildAt(0).hasAlert(a3));
    }
