...
class KeyStrokeDisplayUnitTest {
    ...
    void shouldFormatSymbolShortcut() {
        assertThat(KeyStrokeDisplay.formatSymbols(CTRL_ALT_J), is(equalTo("⌃⌥J")));
    }
    ...
    @Test
    void shouldFormatHtmlSymbolsWithCharacterReferences() {
        KeyStroke commandF = KeyStroke.getKeyStroke(KeyEvent.VK_F, InputEvent.META_DOWN_MASK);

        String html = KeyStrokeDisplay.formatHtmlSymbols(commandF);
