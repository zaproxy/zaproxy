...
class SessionStructureUnitTest {
    ...
    void shouldReturnCorrectNameForMultipartPost() throws Exception {
        ...
        assertThat(
                nodeName,
                is(equalTo(uri + " (aa,cc,ee)(multipart:username,metadata,metadata,metadata)")));
    }
    ...
    static class NodeNameTests {
        ...
        void shouldGetNodeName() throws URIException {
            ...
            assertThat(
                    ...
                    is(
                            equalTo(
                                    "https://www.example.com/ddd/ (aa,cc)(multipart:username,metadata,metadata,metadata)")));
        }
        ...
        void shouldGetLeafName1() throws URIException {
            ...
            assertThat(
                    ...
                    is(equalTo("POST:test(aa,cc)(multipart:username,metadata,metadata,metadata)")));
        }
    ...
    private static String getTestMultipartData(String boundry) {
        return String.join(
                HttpHeader.CRLF,
                "--" + boundry,
